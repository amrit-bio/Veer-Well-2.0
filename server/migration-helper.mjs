...
console.log('   👉 The migration SQL file is at: server/supabase-migration.sql');
console.log('   👉 Copy ALL the SQL code from that file');
...
console.log('📄 First 50 lines of MIGRATION SQL:');
console.log('━'.repeat(80));
console.log('\n');
...
try {
  ...
  if (fs.existsSync(migrationPath)) {
    ...
    console.log(lines);
    console.log('\n... (see supabase-migration.sql for complete SQL) ...\n');
  } else {
