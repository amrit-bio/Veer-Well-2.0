...
-- ============================================================================
-- This migration adds:
-- 1. mha_credentials table (source of truth for valid service IDs)
-- 2. signup_requests table (all incoming signup attempts)
-- 3. approved_users table (final activated accounts after human approval)
-- 4. RLS policies for security
-- 5. Helper functions for the verification pipeline
-- ============================================================================
...
-- Function to check if a service_id is valid and active
...
-- Function to get credential details for a service_id
...
-- Function to create a signup request (Step 1 of pipeline)
...
-- Function to approve a signup request (Step 4 of pipeline)
...
-- Function to reject a signup request
...
-- ============================================================================
-- 7. SEED DATA (Example MHA Credentials)
-- ============================================================================
