...
-- 6. SEED SINGLE ADMIN ACCOUNT
-- This creates the single MHA admin user in Supabase Auth
-- IMPORTANT: Replace 'admin@mha.gov.in' with your actual admin email
-- The password will be set via Supabase Dashboard -> Authentication -> Users

INSERT INTO public.signup_requests (
  full_name, email, rank, force, unit, role, department, designation, review_status
) VALUES (
